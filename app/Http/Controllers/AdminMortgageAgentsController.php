<?php namespace App\Http\Controllers;
	...
	class AdminMortgageAgentsController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Privileges","name"=>"id_cms_privileges","join"=>"cms_privileges,name");
			...
			$this->form[] = ['label'=>'Password Confirmation','name'=>'password_confirmation','type'=>'password','validation'=>'required','width'=>'col-sm-10','help'=>'Please leave empty if not change'];
